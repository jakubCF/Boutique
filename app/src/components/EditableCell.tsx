...
const EditableCell:FC<CellContext<Item, unknown>> = ({getValue, row, column, table}) => {
    ...
    const updateNameById = useMutation({
        mutationFn: (name: string) => {
            ...
            /* TODO: stop requerying entire table and re rendering the whole thing
                just add it to local state and update the databasae 
            */
            setOpen(false);
