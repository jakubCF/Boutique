...
ItemsRouter.get("/", async (_: Request<ItemParams>, res: Response): Promise<any> => {
...
ItemsRouter.patch("/update/name/:id/:name",
    param("id").exists().isInt().toInt(),
...
ItemsRouter.patch("/update/sold/:id/:sold",
    param("id").exists().isInt().toInt(),
    param("sold").exists().toInt().isIn([0, 1]).withMessage("value must be 0 or 1"),
    async (req: Request<ItemParams>, res: Response): Promise<any> => {
